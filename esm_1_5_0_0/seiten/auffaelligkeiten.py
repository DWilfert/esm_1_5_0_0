    ...
    if not df_auffalligkeiten.empty:
        ...
        if standorte:
            selected_standorte = st.multiselect(
                ...
                standorte,
                default=standorte,
                key='auffaelligkeiten_standort_filter'
            )
            df_filtered = df_auffalligkeiten[df_auffalligkeiten["Standort (Excel)"].astype(str).isin(selected_standorte)].copy() if selected_standorte else df_auffalligkeiten.copy()
        else:
